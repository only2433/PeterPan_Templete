...
public class InformationTemplete
{
	 ...
	 */
	public static final String COLOR_THUMBNAIL_BACKGROUND 		= "#fffb8b";
	public static final String COLOR_INTRODUCTION_BACKGROUND 	= "#fff048";
	public static final String COLOR_DEVICE_CODE_TEXT			= "#b5b135";
	public static final String COLOR_INTRODUCTION_TEXT			= "#000000";
	
	/**
	 * 앱 이름
	 */
	public static final String APP_NAME = "PeterPan";
	/**
	 * 어플리케이션의 패키지명 : 반드시 변경
	 */
	public static final String PACKAGE_NAME 				= "com.littlefox.storybook.peterpan";
	
	/**
	 * 영상이 저장될 위치 : 반드시 변경
	 */
	public static final String MP4_FILE_PATH 				= Environment.getExternalStorageDirectory() + File.separator + "Littlefox"+ File.separator+"Storybook"+File.separator+"PeterPan"+File.separator;
	
	/**
	 * 로그 파일 저장 명  : 반드시 변경
	 */
	public static final String LOG_FILE						= "story_book_peterpan.txt";
	 ...
	 */
	public static final String APP_LINK = "https://play.google.com/store/apps/details?id=com.littlefox.storybook.peterpan";
	 ...
	 */
	public static final String HTTP_HEADER_APP_NAME = "LF_App_Storybook_PeterPan";
	
	/**
	 * 구글 애널리틱스를 등록했던 앱의 ID
	 */
	public static final String GOOGLE_ANALYTICS_PROPERTY_ID = "UA-37277849-12";
	
	/**
	 * 하나 아이템의 SKU
	 */
	public static final String ONE_PAY_ITEM_SKU = "lf_sb_pp_1";
	
	/**
	 * 전체 아이템의 SKU
	 */
	public static final String ALL_PAY_ITEM_SKU = "lf_sb_pp_all";
	
	/**
	 * 결제 관련 IN APP BILLING KEY : 앱을 베타테스트로 Publish 한 후에 해당 어플리케이션 정보에서 Services & APIs 항목의  Licensing & IN-APP Billing 의 키를 복사하여 바꾼다.
	 */
	public static final String IN_APP_BILLING_KEY = "";
	 ...
	 * 서버 어플리케이션의 서버키 
	 */
	public static final String SERVER_KEY = "AIzaSyD-29B9srxsz0a3jsIbfMQUGAIs9oqBcZs";
	
	/**
	 * Google API Console 에 등록한 Project ID
	 */
	public static final String SENDER_ID = "606553147156";
	...
	public static final int MAX_AVAILABLE_FOR_PULCHASE_STORY_SIZE = 34;
